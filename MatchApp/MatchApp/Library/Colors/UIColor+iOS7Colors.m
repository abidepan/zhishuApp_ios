...
#pragma mark - Local Colors

+(instancetype) localNavigateColor{
    return [self localGreenColor];
}

+(instancetype) localGreenColor{
    return [UIColor colorWithRed:112.0/255.0 green:167.0/255.0 blue:22.0/255.0 alpha:1.0];
}

+(instancetype) localGreenColor1{
    return [UIColor colorWithRed:160/255.0 green:236/255.0 blue:111/255.0 alpha:1.0];
}

+(instancetype) localBrownColor{
    return [UIColor colorWithRed:214.0/255.0 green:184.0/255.0 blue:66.0/255.0 alpha:1.0];
}

+(instancetype) localBrownColor1{
    return [UIColor colorWithRed:250.0/255.0 green:236.0/255.0 blue:111.0/255.0 alpha:1.0];
}

+(instancetype) localBlueColor{
    return [UIColor colorWithRed:92.0/255.0 green:197.0/255.0 blue:255.0/255.0 alpha:1.0];
}

+(instancetype) localBlueColor1{
    return [UIColor colorWithRed:0.0/255.0 green:136.0/255.0 blue:204.0/255.0 alpha:1.0];
}

+(instancetype) localRedColor{
    return [UIColor colorWithRed:255.0/255.0 green:130.0/255.0 blue:133.0/255.0 alpha:1.0];
}

+(instancetype) localRedColor1{
    return [UIColor colorWithRed:213.0/255.0 green:45.0/255.0 blue:45.0/255.0 alpha:1.0];
}
